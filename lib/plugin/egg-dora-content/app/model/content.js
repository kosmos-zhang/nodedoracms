...
module.exports = app => {
  ...
  ContentSchema.path('regDateBegin').get(function(v) {
    return moment(v).format('YYYY-MM-DD');
  });
  ContentSchema.path('regDateEnd').get(function(v) {
    return moment(v).format('YYYY-MM-DD');
  });
  ContentSchema.path('actDateBegin').get(function(v) {
    return moment(v).format('YYYY-MM-DD');
  });
  ContentSchema.path('actDateEnd').get(function(v) {
    return moment(v).format('YYYY-MM-DD');
  });
