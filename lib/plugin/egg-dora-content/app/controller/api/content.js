...
let ContentController = {
    ...
    /**
     * @api {get} /api/content/getList 查询文档列表
     * @apiDescription 根据参数获取对应的文档列表,默认按时间查询，可作为发现栏目列表
    ...
    /**
     * @api {get} /api/content/getContent 查询文档详情
     * @apiDescription 查询文档详情(只普通文档或专题)
    ...
    /**
     * @api {get} /api/content/getMyFavoriteContents 获取我收藏的文档列表
     * @apiDescription 获取我收藏的文档列表 带分页
