...
let RegUserController = {
     ...
     * @apiDescription 我的关注，获取我关注的创作者，专题，已经关注创作者的文档等相关信息，目前不带分页
    ...
    /**
     * @api {get} /api/user/askContentThumbsUp 文档点赞/取消点赞
     * @apiDescription 文档点赞/取消点赞，需要登录态
     * @apiName /user/askContentThumbsUp
     * @apiGroup User
     * @apiParam {string} token 登录时返回的参数鉴权
     * @apiParam {string} praiseState in:赞 out:取消赞
     * @apiParam {string} contentId 文档ID/评论ID/社群帖ID
     * @apiSuccess {json} result
     * @apiSuccessExample {json} Success-Response:
     *{
     *    "status": 200,
    ...
    /**
     * @api {get} /api/user/favoriteContent 收藏/取消收藏文档
     * @apiDescription 收藏/取消收藏文档，需要登录态
     * @apiName /user/favoriteContent
     * @apiGroup User
     * @apiParam {string} token 登录时返回的参数鉴权
     * @apiParam {string} favoriteState in:收藏 out:取消收藏
     * @apiParam {string} contentId 文档ID
     * @apiSuccess {json} result
     * @apiSuccessExample {json} Success-Response:
     *{
     *    "status": 200,
    ...
    /**
     * @api {get} /api/user/despiseContent 踩/取消踩 文档
     * @apiDescription 踩/取消踩文档，需要登录态
     * @apiName /user/despiseContent
     * @apiGroup User
     * @apiParam {string} token 登录时返回的参数鉴权
     * @apiParam {string} despiseState in:踩 out:取消踩
     * @apiParam {string} contentId 文档ID/评论ID
     * @apiSuccess {json} result
     * @apiSuccessExample {json} Success-Response:
     *{
     *    "status": 200,
