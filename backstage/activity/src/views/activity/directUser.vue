...
<script>
import { redictActivityToUsers, regUserList } from "@/api/activity";
...
export default {
  ...
  methods: {
    ...
    confirm() {
      this.$store.dispatch("activity/hideDirectUserForm");
    },
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          redictActivityToUsers(currentParams)
            .then(result => {
