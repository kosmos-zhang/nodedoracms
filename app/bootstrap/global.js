...
global.getContentListFields = (type = '') => {
  ...
  let files = null;
  if (type == 'normal') {
    files = '_id title stitle sImg uAuthor date updateDate discription clickNum roofPlacement type videoImg state dismissReason categories isTop regDateBegin regDateEnd actDateBegin actDateEnd'
  } else if (type == 'simple') {
    ...
    files = '_id title stitle sImg uAuthor date discription clickNum roofPlacement type appShowType imageArr videoArr duration simpleComments comments videoImg state dismissReason categories isTop regDateBegin regDateEnd actDateBegin actDateEnd'
  }
